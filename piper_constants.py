...
START_ARM_POSE = [0.93609703, 1.75400805, -1.06813896, 1.65906382, -0.77552718, -1.09759986, 0.035, -0.035, -0.92985469, 1.74810922, -1.06983697, -1.6633122, -0.77140248, 1.10903978, 0.035, -0.035]
...
# Global Config for Many Cubes Task
MANYCUBES_COLORS = [None] # Mutable list to store color sequence
MANYCUBES_CONFIG = {'x_shift': 0.0} # Mutable dict to store config
